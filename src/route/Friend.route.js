...
class FriendRoute {
    ...
    async addFriend(req, res, next) {
        ...
        try {
            ...
            await UserRepository.removeFriendSendRequest(req.params.idUser, req.query.friendid);
            await UserRepository.removeFriendReciveRequest(req.query.friendid, req.params.idUser);
